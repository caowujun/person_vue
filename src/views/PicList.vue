<template>
  <el-card class="box-card" shadow="hover">
    ...
    <el-form :inline="true" :model="formInline" class="demo-form-inline" style="text-align: left;" ref="form"
      ...
      <el-form-item>
        <el-button type="primary" plain @click="onBack" size="small" icon="el-icon-search"> {{$t('form.back')}}
        </el-button>
      </el-form-item>
    ...
    <el-table :data="tableData" style="width: 100%" border stripe size="small" v-loading="loading"
      ...
      <el-table-column :label="$t('album.picsize')" prop="picsize">
      </el-table-column>
...
export default {
  ...
  methods: {
    loadList () {
      this.$http.get(this.$apiList.albumpage, {
        params: {
